...
addEventHandler("onClientResourceStart", getResourceRootElement(),
	...
	function processColorPicker()
		...
		if activeColorId == 1 then
			...
			setElementData(vehicleElement, "vehicleColor", {colorInputs.r, colorInputs.g, colorInputs.b}, false)
		...
		elseif activeColorId == 6 then
			exports.nm_spinner:setPreviewColor(vehicleElement, colorInputs.r, colorInputs.g, colorInputs.b)
		end
	end
		...
		if colorPicker then
			if key == "mouse1" then
				if press then
					...
					if cursorX >= panelPosX + respc(10) and cursorY >= panelPosY + panelHeight - respc(30) and cursorX <= panelPosX + respc(10) + respc(244) and cursorY <= panelPosY + panelHeight - respc(30) + respc(20) then
...
addEventHandler("onClientRender", getRootElement(),
	function ()
		if colorPicker then
			...
			-- ** Content
			dxDrawRectangle(panelPosX, panelPosY, panelWidth, panelHeight + respc(40), tocolor(23, 25, 24))
    		...
    		dxDrawRectangle(panelPosX + respc(10), panelPosY + panelHeight - respc(30), respc(244), respc(20), tocolor(255, 255, 255, 255))
    		dxDrawImage(panelPosX + respc(10), panelPosY + panelHeight - respc(30), respc(172), respc(20), "files/luminance.png", 0, 0, 0, tocolor(convertHSLToRGB(hue, saturation, 0.5) * 255, convertHSLToRGB(hue, saturation, 0.5) * 255, convertHSLToRGB(hue, saturation, 0.5) * 255))
			
			for i = 0, respc(244) do
				local r, g, b = convertHSLToRGB(hue, saturation, i / respc(244))
			...
			dxDrawRectangle(colorX - respc(5), colorY - respc(5), respc(10), respc(10), tocolor(33, 35, 36))
			dxDrawRectangle(colorX - respc(4), colorY - respc(4), respc(8), respc(8), tocolor(r, g, b))

			local luminanceX = reMap(lightness, 0, 1, 0, respc(244))
			local r, g, b = convertHSLToRGB(hue, saturation, lightness)

			dxDrawRectangle(panelPosX + respc(10) + luminanceX - respc(3), panelPosY + panelHeight - respc(30) - respc(1), respc(6), respc(22), tocolor(33, 35, 36))
			...
			if isLuminancePicking then
				...
				if moveX < panelPosX + respc(10) then
					...
					if moveX > panelPosX + respc(10) + respc(244) then
						moveX = panelPosX + respc(10) + respc(244)
					end
				end

				lightness = reMap(moveX - (panelPosX + respc(10)), 0, respc(244), 0, 1)
			...
			if colorId >= 7 then
				exports.seal_hud:renderSpeedoForTest(vehicleElement, {r, g, b}, colorId)
			end
			...
			dxDrawRectangle(startX, startY, hexWidth + respc(5), respc(30), tocolor(53, 53, 53, 255 * 0.85))
			dxDrawText(colorInputs.hex, startX, startY, endX + respc(5), endY, tocolor(255, 255, 255, 255), 1, Roboto, "center", "center")
			...
			dxDrawRectangle(startX, startY, rgbWidth + respc(5), respc(30), tocolor(53, 53, 53, 255 * 0.85))
			dxDrawText(colorInputs.b, startX, startY, endX, endY, tocolor(255, 255, 255, 255), 1, Roboto, "center", "center")
			...
			dxDrawRectangle(startX, startY, rgbWidth + respc(5), respc(30), tocolor(53, 53, 53, 255 * 0.85))
			dxDrawText(colorInputs.g, startX, startY, endX, endY, tocolor(255, 255, 255, 255), 1, Roboto, "center", "center")
			...
			dxDrawRectangle(startX, startY, rgbWidth + respc(5), respc(30), tocolor(53, 53, 53, 255 * 0.85))
			dxDrawText(colorInputs.r, startX, startY, endX, endY, tocolor(255, 255, 255, 255), 1, Roboto, "center", "center")
			
			-- Title
			endX = endX - rgbWidth - respc(10)

			dxDrawText("RGB: ", 0, startY, endX, endY, tocolor(94, 193, 230), 1, Roboto, "right", "center")
