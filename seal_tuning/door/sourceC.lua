	...
	function (timeSlice)
		...
		for veh in pairs(moonbeams) do -- GMC Savana
			if isElement(veh) then
				...
				for i = 4, 5 do
					local ratio = getVehicleDoorOpenRatio(veh, i)
					local rx, ry, rz = -1.0231127738953, 0.09013592164993, 0.14886932730675
					local doorname = "door_lr_dummy"

					if i == 5 then
						rx, ry, rz = 1.0231127738953, 0.09013592164993, 0.14886932730675
						doorname = "door_rr_dummy"
					end

					setVehicleComponentRotation(veh, doorname, 0, 0, 0)
					setVehicleComponentPosition(veh, doorname, rx * (1 + 0.1 * ratio), ry * (1 - 12 * ratio), rz)
				end
			end
		end
