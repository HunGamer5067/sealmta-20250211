...
local Rubik = dxCreateFont("files/Rubik.ttf", 22, false, "proof")
...
addEventHandler("onClientRender", getRootElement(),
	function ()
		if shutdownTimer then
			...
			dxDrawBorderText("Szerver leállás: " .. secondsToMinutes(math.ceil(timeLeft / 1000)), 0, 5, screenX, screenY, tocolor(215, 89, 89), 1, Rubik, "center", "top")
		end
	end)
