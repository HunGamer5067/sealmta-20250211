	...
	function ()
		...
		if radarDebugMode then
			if myVehicleElement then
				...
				for i = 1, 360, 30 do
					...
					dxDrawLine3D(myShipPosX, myShipPosY, myShipPosZ + lineHeight, myShipPosX + x, myShipPosY + y, myShipPosZ + lineHeight, tocolor(74, 223, 191, 150), 3)
					dxDrawLine3D(myShipPosX + x, myShipPosY + y, myShipPosZ, myShipPosX + x, myShipPosY + y, myShipPosZ + lineHeight, tocolor(74, 223, 191, 150), 3)
				end
				...
				dxDrawLine3D(myShipPosX, myShipPosY, z, myShipPosX + x1, myShipPosY + y1, z, tocolor(74, 223, 191, 150), 10)
				dxDrawLine3D(myShipPosX, myShipPosY, z, myShipPosX + x2, myShipPosY + y2, z, tocolor(74, 223, 191, 150), 10)
				dxDrawLine3D(myShipPosX + x1, myShipPosY + y1, z, myShipPosX + x2, myShipPosY + y2, z, tocolor(74, 223, 191, 150), 10)
			end
		end
								...
								if guiPosX and guiPosY then
									...
									if objectOnCraneHead[contactElement] then
										if getElementModel(objectOnCraneHead[contactElement]) ~= 964 then
											...
											dxDrawImage(guiPosX, guiPosY, guiSize, guiSize, "files/crane_down.png", 0, 0, 0, tocolor(74, 223, 191, craneAlpha))
										else
											...
											dxDrawImage(craneLeftPosX, guiPosY, guiSize, guiSize, "files/crane_left.png", 0, 0, 0, tocolor(74, 223, 191, craneLeftAlpha))

											dxDrawRectangle(craneDownPosX, guiPosY, guiSize, guiSize, tocolor(0, 0, 0, 150))
											dxDrawImage(craneDownPosX, guiPosY, guiSize, guiSize, "files/crane_down.png", 0, 0, 0, tocolor(74, 223, 191, craneDownAlpha))
										end
									else
										local craneAlpha = 150
										...
										dxDrawRectangle(guiPosX, guiPosY, guiSize, guiSize, tocolor(0, 0, 0, 150))
										dxDrawImage(guiPosX, guiPosY, guiSize, guiSize, "files/crane.png", 0, 0, 0, tocolor(74, 223, 191, craneAlpha))
									end
								end
							end
						end
		...
		if myVehicleElement then
			if radarAbilityShips[myVehicleModel] then
				...
				dxDrawRectangle(gridPosX, gridPosY, gridSize, gridSize, tocolor(15, 15, 15, 25))
				...
				dxDrawRectangle(gridPosX, gridPosY + gridSize + respc(8), gridSize, respc(24), tocolor(	15, 15, 15, 125))
				...
				if crabCrates then
					if #crabCrates > 0 then
						...
						dxDrawText("#dfb551Ketrecek: " .. #crabCrates .. " db#ffffff\n#bc873dRák: " .. math.floor(totalWeight * 10) / 10 .. " kg", radarCenterX - positionOffset, gridPosY + gridSize + respc(32), radarCenterX + positionOffset, bgPosY + bgHeight, tocolor(255, 255, 255, 200), 0.7, Roboto, "center", "center", false, false, false, true)
					end
				end
