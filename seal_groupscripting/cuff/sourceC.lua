	...
	function (dataName, oldValue)
		...
		elseif dataName == "cuffed" then
			...
			if cuffed then
				...
				exports.seal_boneattach:attachElementToBone(leftCuffObj[source], source, 11, 0, 0, 0, 90, -45, 0)

				rightCuffObj[source] = createObject(cuffModel, 0, 0, 0)
				setElementDoubleSided(rightCuffObj[source], true)
				exports.seal_boneattach:attachElementToBone(rightCuffObj[source], source, 12, 0, 0, 0, 90, -45, 0)
