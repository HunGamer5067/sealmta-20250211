...
function renderTraffipaxMeter()
    ...
    if theVehicle then
        ...
        drawText("Target Speed:", (meterPos.x + (10)) + (0) * ((meterPos.w / 4 - (20)) + (20)), (meterPos.y + meterPos.h / 2 - (10)) - respc(60), meterPos.w / 4 - (20), meterPos.h / 2, tocolor(200, 200, 200, 200), 1, Rubik)
        ...
        drawText("Range / Plate:", (meterPos.x + (10)) + (1) * ((meterPos.w / 4 - (20)) + (20)), (meterPos.y + meterPos.h / 2 - (10)) - respc(60), meterPos.w / 4 - (20), meterPos.h / 2, tocolor(200, 200, 200, 200), 1, Rubik)
        ...
        drawText("Lock:", (meterPos.x + (10)) + (2) * ((meterPos.w / 4 - (20)) + (20)), (meterPos.y + meterPos.h / 2 - (10)) - respc(60), meterPos.w / 4 - (20), meterPos.h / 2, tocolor(200, 200, 200, 200), 1, Rubik)
        ...
        drawText("Patrol Speed:", (meterPos.x + (10)) + (3) * ((meterPos.w / 4 - (20)) + (20)), (meterPos.y + meterPos.h / 2 - (10)) - respc(60), meterPos.w / 4 - (20), meterPos.h / 2, tocolor(200, 200, 200, 200), 1, Rubik)
        ...
        drawText(tostring(datasFromRender.plate), (meterPos.x + (10)) + (1) * ((meterPos.w / 4 - (20)) + (20)), (meterPos.y + meterPos.h / 2 - (10)) + (meterPos.h / 2) / 3 + 10, meterPos.w / 4 - (20), (meterPos.h / 2) / 2.1, tocolor(200, 200, 200, 200), 0.9, Rubik)
        ...
        if isThatVehicle then
            dxDrawLine3D(startX, startY, startZ, hitX, hitY, hitZ, tocolor(94, 193, 230, 180), 5)

        else
            dxDrawLine3D(startX, startY, startZ, endX, endY, endZ, tocolor(94, 193, 230, 180), 5)
        end
    end
end
