...
addEvent("showSirenGui", true)
addEventHandler("showSirenGui", getRootElement(),
	function(vehicle)
		if getElementData(vehicle, "lightBridge") == 1 or getElementData(vehicle, "civilSiren") then
			sirenSound = getElementData(vehicle, "sirenSound") or 0
			outputChatBox("#598ed7[SealMTA - Rendőrség]:#FFFFFF A szirénakezelő panel eltüntetéséhez/előhozásához használd a /togsirengui parancsot.", 255, 255, 255, true)
			sirenVeh = true
			sirenGui = true
		end
	end
	...
	function (player, seat)
		if player == localPlayer then
			if seat == 0 or seat == 1 then
				...
				if getElementData(source, "lightBridge") == 1 or getElementData(source, "civilSiren") then
...
addEventHandler("onClientPreRender", getRootElement(),
	function()
		...
		if pedveh and not sirenVeh and getVehicleSirensOn(pedveh) and not getElementData(pedveh, "civilSiren") then
			setVehicleSirensOn(pedveh, false)
		end
	end
)
...
function loadFonts()
	Rubik = exports.seal_core:loadFont("Rubik.ttf", respc(18), false, "proof")
	LcdFont = exports.seal_core:loadFont("counter.ttf", respc(30), false, "proof")
	RubikS = exports.seal_core:loadFont("Rubik.ttf", respc(11), false, "proof")
	handFont = exports.seal_core:loadFont("lunabar.ttf", respc(26), false, "proof")
	lunabarFont = exports.seal_core:loadFont("hand.otf", respc(26), false, "proof")
	cameraFont = exports.seal_core:loadFont("counter2.ttf", respc(20), false, "proof")
end
			...
			if isElement(playerVehicle) then
				if sirenGui and sirenVeh then
					if getPedOccupiedVehicleSeat(localPlayer) == 0 or getPedOccupiedVehicleSeat(localPlayer) == 1 then
						...
						if getElementData(playerVehicle, "lightBridge") == 1 or getElementData(playerVehicle,"sirens->State") or getElementData(playerVehicle, "civilSiren") then
							...
							-- ** Háttér
							dxDrawRectangle(x, y, sx, sy, tocolor(26, 29, 31, 255))
							dxDrawRectangle(x, y, sx, 25, tocolor(21, 24, 27, 255))

							-- ** Cím
							dxDrawText("SealMTA - #598ed7Sziréna", x + respc(5), y + respc(6), x + sx, y + respc(20), tocolor(255, 255, 255), 0.65, Rubik, "center", "center", false, false, false, true)
							...
							if getVehicleSirensOn(currVeh) and sirenParams.SirenType ~= 1 then
								dxDrawImage(x + 2 + respc(7.5), y + respc(28), respc(32), respc(32), "files/images/siren.png", 0, 0, 0, tocolor(89, 142, 215, buttonAlpha))
							else
								dxDrawImage(x + 2 + respc(7.5), y + respc(28), respc(32), respc(32), "files/images/siren.png", 0, 0, 0, tocolor(215, 89, 89, buttonAlpha))
							end
							...
							if sirenSound == 0 then
								dxDrawImage(x + 2 + respc(15) + respc(32), y + respc(32), respc(26), respc(26), "files/images/soundoff.png", 0, 0, 0, tocolor(89, 142, 215, buttonAlpha))
							else
								dxDrawImage(x + 2 + respc(15) + respc(32), y + respc(32), respc(26), respc(26), "files/images/soundoff.png", 0, 0, 0, tocolor(215, 89, 89, buttonAlpha))
							end
							...
							if sirenSound == 1 then
								dxDrawImage(x + 2 + respc(22.5) + respc(64), y + respc(32), respc(26), respc(26), "files/images/sound.png", 0, 0, 0, tocolor(89, 142, 215, buttonAlpha))
							else
								dxDrawImage(x + 2 + respc(22.5) + respc(64), y + respc(32), respc(26), respc(26), "files/images/sound.png", 0, 0, 0, tocolor(215, 89, 89, buttonAlpha))
							end
							...
							if sirenSound == 2 then
								dxDrawImage(x + 2 + respc(30) + respc(96), y + respc(32), respc(26), respc(26), "files/images/sound.png", 0, 0, 0, tocolor(89, 142, 215, buttonAlpha))
							else
								dxDrawImage(x + 2 + respc(30) + respc(96), y + respc(32), respc(26), respc(26), "files/images/sound.png", 0, 0, 0, tocolor(215, 89, 89, buttonAlpha))
							end
							...
							if sirenSound == 3 then
								dxDrawImage(x + 2 + respc(37.5) + respc(128), y + respc(32), respc(26), respc(26), "files/images/sound.png", 0, 0, 0, tocolor(89, 142, 215, buttonAlpha))
							else
								dxDrawImage(x + 2 + respc(37.5) + respc(128), y + respc(32), respc(26), respc(26), "files/images/sound.png", 0, 0, 0, tocolor(215, 89, 89, buttonAlpha))
							end
...
function triggerSirenFunctions(state)
	...
	if state == "switchTheSiren" then
		if getTickCount() - switchClickTick >= 1000 then
			...
			exports.seal_chat:localActionC(localPlayer, "megnyomott egy gombot a műszerfalon.")
		else
			exports.seal_hud:showInfobox("e", "Ilyen gyorsan nem kéne kapcsolgatni!")
		end
	...
	elseif state == "sirenHorn" then
		if getTickCount() - hornClickTick >= 350 then
			...
			exports.seal_hud:showInfobox("e", "Ilyen gyorsan nem kéne nyomogatni!")
		end
	end
end
...
addCommandHandler("sirenpanel",
	function (commandName, sirenId)
		...
		if not sirenId or sirenId < 1 or sirenId > 6 then
			outputChatBox("#4adfbf[Használat]: #ffffff/" .. commandName .. " [1-6]", 255, 255, 255, true)
			return
		end
	...
	function (key, press)
		if key == "p" and press then
			...
			if currVeh and getVehicleController(currVeh) == localPlayer then
				...
				if sirenVehicles[model] or getElementData(currVeh, "civilSiren") or model == 433 or model == 427 or model == 528 or model == 544 or model == 601 or model == 443 or model == 525 then
