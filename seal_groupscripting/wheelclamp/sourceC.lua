...
function renderWheelClamping()
    if startTick then
        ...
        dxDrawText("Kerékbilincs " .. text .. "...", barX + barW / 2, barY - dxGetFontHeight(1, RubikS), nil, barY + 2,tocolor(200, 200, 200), 1, RubikS, "center")
        ...
        dxDrawRectangle(barX + 2 - (barW - 4) * barFill / 2 + (barW - 4) / 2, barY + 2, (barW - 4) * barFill, barH - 4, tocolor(94, 193, 230, 200))  
