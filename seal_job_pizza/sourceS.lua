								...
								if getElementData(thePlayer, "char.Job") == jobID then
									...
									if getDistanceBetweenPoints3D(playerX, playerY, playerZ, targetX, targetY, targetZ) <= 3 then
										...
										if isPedInVehicle(thePlayer) then
											outputChatBox("#d75959[SealMTA - Pizzafutár]: #ffffffElőbb szállj ki a járműből.", thePlayer, 255, 255, 255, true)
											return
										end

										if jobVehicle ~= source then
											outputChatBox("#d75959[SealMTA - Pizzafutár]: #ffffffEz nem a te robogód.", thePlayer, 255, 255, 255, true)
											return
										end
										...
										if carryingPizza then
											...
											if pizzaBoyInventory then
												...
												exports.seal_chat:localAction(thePlayer, "berakott " .. #carryingPizza .. " darab pizzát a robogóba.")
											end
										else
						...
						if colData and colData[1] == thePlayer then
							...
							if carryingPizza[1] then
								...
								if carryingPizza[1] == currentJob.pizzas[orderId] then
									...
									local newPP = math.random(25, 75)

									exports.seal_core:giveMoney(thePlayer, 50000, "pizzaDelivered")

									setElementData(thePlayer, "acc.premiumPoints", playerPP + newPP)
									...
									exports.seal_hud:showInfobox(thePlayer, "s", "Sikeresen leszállítottad a pizzát és kerestél 50 000$-t és " .. newPP .. " prémiumpontot!")
								else
									exports.seal_hud:showInfobox(thePlayer, "e", "Ez a megrendelő nem ilyen pizzát kért!")
								end
							end
						end
					end
