...
addEventHandler("createBusProgressbar", getRootElement(),
	function (waitingDuration)
		exports.seal_hud:showInfobox("i", "Várd meg, amíg felszállnak az utasok!")
	...
	function (lineType, markerId, skins)
		...
		if lineType then
			...
			if nextWaypoint then
				...
				setTimer(outputChatBox, 500, 1, "[SealMTA - Buszsofőr]: #ffffffKövetkező megálló: #4adfbf" .. zoneName, lineColor[1], lineColor[2], lineColor[3], true)
