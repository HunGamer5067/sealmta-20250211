...
if isClientSide then
  ...
  function setRotationMatrix(...)
    return pAttach:setRotationMatrix(...)
  end
  addEvent("pAttach:setRotationMatrix", true)
  addEventHandler("pAttach:setRotationMatrix", resourceRoot, setRotationMatrix)
  function setRotationQuaternion(...)
    return pAttach:setRotationQuaternion(...)
  end
  addEvent("pAttach:setRotationQuaternion", true)
  addEventHandler("pAttach:setRotationQuaternion", resourceRoot, setRotationQuaternion)
  function disableScreenCheck(...)
    return pAttach:disableScreenCheck(...)
  end
  addEvent("pAttach:disableScreenCheck", true)
  addEventHandler("pAttach:disableScreenCheck", resourceRoot, disableScreenCheck)
  ...
  do
    ...
    function setRotationQuaternion(element, q)
      assert(isElement(element), "Expected element at argument 1, got " .. type(element))
      cache[element].q = q
      return triggerClientEvent("pAttach:setRotationQuaternion", resourceRoot, element, q)
    end
